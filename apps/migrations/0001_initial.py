# Generated by Django 5.0.8 on 2024-09-21 12:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deptno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.dept')),
                ('mgr', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='apps.emp')),
            ],
        ),
    ]
